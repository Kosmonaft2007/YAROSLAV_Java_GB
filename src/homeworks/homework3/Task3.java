...
public class Task3 {
	...
	находим значения минимум, максимум и среднее арифметическое с помощью Stream API
        Чтобы определить значения минимум, максимум нужно вызвать терминальный метод min/max и 
	передать в параметры потока переопредленный метод compare, класса-обертки Integer 
	*/
