...
public class LaptopFilter {
    ...
    то мы пропускаем интерацию, иначе если, не одно условие не выполнится, добавляем данное значение Laptop в ArrayList
    ...
    public static void showLaptopByFilteringOptions(Map<String, String> filteringOptions, Set<Laptop> laptopsSet) {
        ...
        for (Laptop laptop : laptopsSet) {
            ...
            если первое условие верно, проверяем заданное значение,
            если значение в данном экземпляре класса, не подходит под требуемые параметры, то пропускаем текущую итерацию
             */
