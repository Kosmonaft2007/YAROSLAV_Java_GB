...
public class Task3 {
    ...
    private static String[][] fileToStringArray(String path) {
        ...
        /* создаем двумерный массив, для записи в него информации о студентах
         зная что кол-во столбцов у нас будет константным задаем это значение сразу,
         а кол-во строк будет равно длине массива array.
        */
        String[][] temp = new String[array.length][6];

        // используем шаблон регулярного выражения для разделения строки только по символам и числам
    ...
    /*
    метод обрабатывает информацию о студентах,
    с помощью StringBuilder форматирует общую строку из двумерного массива 
    и возвращает в виде обычной строки (String)
     */
